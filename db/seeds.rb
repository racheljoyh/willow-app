...
l1 = Listing.create(creator_id: u1.id, price: 1500, footage: 650, bedrooms: 1, bathrooms: 1, description: "Second floor, bright, condo in Whitter Neighborhood near City Park with private parking spot.", date_available: Date.today,  property_owner: 'HotPads', address: '301 S Lamar St., Lakewood CO 80226', images:[""])
